...
library AaveAddressBookV2 {
  ...
  function getMarket(string calldata market) public pure returns (Market memory m) {
    if (keccak256(abi.encodePacked(market)) == keccak256(abi.encodePacked(AaveV2Ethereum))) {
      return
        Market(
      ...
      keccak256(abi.encodePacked(market)) == keccak256(abi.encodePacked(AaveV2EthereumAMM))
    ) {
      return
        Market(
      ...
      keccak256(abi.encodePacked(market)) == keccak256(abi.encodePacked(AaveV2EthereumArc))
    ) {
      return
        Market(
      ...
      keccak256(abi.encodePacked(market)) == keccak256(abi.encodePacked(AaveV2Avalanche))
    ) {
      return
        Market(
